...
export const Preview = props => {
    ...
    return (
        <Grid container>            
            <Grid item xs={4} dangerouslySetInnerHTML={{__html: content1}}/>
            <Grid item xs={4} dangerouslySetInnerHTML={{__html: content2}}/>
            <Grid item xs={4} dangerouslySetInnerHTML={{__html: content3}}/>            
        </Grid>
    )
}
