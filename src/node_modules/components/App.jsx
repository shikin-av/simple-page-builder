...
class App extends React.Component {
    ...
    changeElementContent = ({row, element, content}) => {
        const {rows} = this.state
        const rowIndex = _.findIndex(rows, item => {
            return item.id === row.id
        })
        const elementIndex = _.findIndex(rows[rowIndex].elements, el => {
            return el.id === element.id
        })
        rows[rowIndex].elements[elementIndex].content = content
        this.tmpRows = rows
    }
